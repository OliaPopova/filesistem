...
export default class extends AbstractView {
    constructor(params) {
        super(params);
        this.setTitle("VIP_GZ_technological_platform_for_rapid_response_to_infectious_diseases");
    }
...
.link {
  ...
  border-radius: 15px;
         ...
         <h1> ВИП ГЗ технологическая платформа оперативного реагирования на инфекционные заболевания </h1>
